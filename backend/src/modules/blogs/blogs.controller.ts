...
export class BlogsController {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'List recently deleted blogs (CMS trash)',
    description:
      'Soft-deleted blogs only, newest first. Restore with POST /blogs/:id/restore.',
  })
    ...
    return {
      ...
      message:
        result.meta.total === 0
          ...
          : 'Deleted blogs fetched successfully',
      ...result,
    };
  }
