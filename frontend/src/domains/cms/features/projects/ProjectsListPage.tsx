...
export default function ProjectsListPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const message = cmsErrorMessage(err, "Failed to load projects");
      setError(message);
  ...
  return (
    <CmsListShell
      description="Manage projects. Soft-deleted items stay in Recently Deleted until you restore them."
                  ...
                  <TableRow key={project.id}>
                    ...
                    <TableCell>
                      {tab === "deleted" ? (
                        ...
                        >
                          {formatCmsDateTime(project.deletedAt)}
                        </Typography>
                      ) : (
                        <Typography
                          variant="caption-1"
