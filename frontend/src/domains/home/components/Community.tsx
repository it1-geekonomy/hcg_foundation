      ...
      <div className="max-w-full">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-12 mb-10 md:mb-14">
            ...
            <div className="flex sm:hidden flex-wrap gap-2">
              {communityTags.map((tag, i) => (
                <Typography variant="label-2"
                  as="span"
                  key={i}
                  className="px-3 py-1.5 bg-[#876900] text-white text-center whitespace-nowrap"
                >
                  {tag}
                </Typography>
              ))}
          ...
          <div className="order-1 lg:order-2 max-w-4xl lg:text-left">
            ...
            <Typography variant="body-2" as="p" className="text-[#2D2300] mt-3 md:mt-4">
        ...
        >
          ...
          >
            ...
            <Typography variant="body-5" as="p" className="text-white mb-4 md:mb-5 lg:mb-6">
            ...
            >
              <Typography variant="button-2" as="span" className="text-[#373737]">
