    ...
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-[#8D8D8D66] p-6 shadow-2xl backdrop-blur-xl">
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl">
        <Image
          ...
          alt={name}
          fill
          sizes="(max-width: 639px) 65vw, (max-width: 767px) 50vw, (max-width: 1023px) 33vw, (max-width: 1279px) 30vw, 25vw"
  ...
  return (
    ...
    >
      <Typography
        variant="hero"
        as="h2"
        className="mx-auto mb-14 max-w-2xl px-4 font-manrope font-medium text-neutral-800"
      >
      ...
      >
        ...
        >
          {loopedStories.map((story, i) => (
            <div
              key={`${story.name}-${i}`}
              className="shrink-0 basis-[65vw] cursor-pointer sm:basis-[calc(50vw-34px)] md:basis-[calc(33.333vw-37px)] lg:basis-[calc(30vw-40px)] xl:basis-[calc(25vw-48px)]"
              onPointerEnter={(e) => {
