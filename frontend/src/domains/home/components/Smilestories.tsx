  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-[#8D8D8D66] p-6 shadow-2xl backdrop-blur-xl">
      ...
      <div className="flex items-center justify-between gap-2 pt-4">
        <div>
          <Typography variant="heading-8" as="p" className="text-left text-white !font-bold">
            {name}
          </Typography>
          <Typography variant="text-2"
            as="p"
            className="mt-1 flex items-center gap-2 text-white text-nowrap !font-medium"
          >
  ...
  return (
    ...
    >
      <Typography variant="heading-3"
        as="h2"
        className="mx-auto mb-14 text-center px-4 text-neutral-800 !font-medium"
      >
