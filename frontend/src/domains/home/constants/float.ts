export const images = [
  ...
  { src: "/Kindness/kindness2.png", rotate: "rotate-12", delay: "0.7s", duration: "4.5s", top: "top-6 md:top-16" },
  ...
  { src: "/Kindness/kindness5.png", rotate: "rotate-6", delay: "1s", duration: "4.8s", top: "top-2 md:top-6" },
];